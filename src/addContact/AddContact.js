...
const AddContact = () => {
  ...
  const onSubmitContact = (e) => {
    ...
    axiosIntance
      ...
      .then((res) => {
        ...
        console.log("res addcontact" + JSON.stringify(res));
      })
      .catch((err) => {
        Swal.fire("contact added failure", "try", "error");

        console.log("err add contact" + JSON.stringify(err));
      });
  };
  ...
  useEffect(() => {
    console.log({name, email, adress, mobile, status, company });
  }, [name, email, adress, mobile, status, company ]);
  return (
    <Main>
